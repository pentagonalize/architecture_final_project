...
#define HIDDEN_NODES 128 // Number of hidden nodes
...
int main(int argc, char *argv[])
{
    ...
    printf("  Activation Function: tanh_activation\n");
    ...
    save_weights_biases("model_128_tanh_activation.bin");
